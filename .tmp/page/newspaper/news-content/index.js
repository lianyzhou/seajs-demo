define("page/newspaper/news-content/index", [ "page/newspaper/news-content/tpl/newslist.tpl", "page/newspaper/news-content/css/news-content.css", "io/newspaper" ], function(require, exports, module) {
    ...
    var io = require("io/newspaper"), $el, newsList, $sortable, lastOrder = [], delegate, nodes;
    ...
    var delegateEvt = {
        toggle: function(e) {
            ...
            $target.removeClass("ui-icon-plusthick ui-icon-minusthick").addClass(cls);
        }
    };
    function bindEvt() {
    ...
    function buildTpl() {
        ...
        var $dom = $(html).css("opacity", 0).animate({
            opacity: 1
        });
        $el.empty().append($dom);
        nodes = $.builder($el);
